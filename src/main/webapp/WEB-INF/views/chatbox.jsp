	...
	<div class="container">
		<div class="conversation-container">
			...
			<div class="left-side active">
				<div class="add-group border toggle-btn" data-id="add-group" onclick="toggleModal(this, true)"><i class="fa fa-plus-circle"> Create Group</i></div>
				<h2>
					<a href="<c:url value="/users/update"/>"
						style="text-decoration: none; color: #F8E6CB;margin-right: 3rem;">Welcome
						${user.username}</a>
					|
				...
				<div class="tab-control">
					...
					<i class="fa fa-users" onclick="chatGroup(this)"></i>
				</div>
